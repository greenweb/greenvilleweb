...
<header id="site-header" class="<?php echo esc_attr( ttfmake_get_site_header_class() ); ?> gw-site-header" role="banner">
	...
	<?php endif; ?>
	<div class="site-header-main gw">
		<div class="container">
			<div class="gw-logo-slider">
